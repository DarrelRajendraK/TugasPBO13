...
public class App {
    public static void main(String[] args) {
        ...
        String namaKasir = " Darrel ";
        String userName = "darrelrk";
        String inputUserName;
        String password = "darrelrk1213";
        String inputPassword;
        String captcha = "D1r2k3";
        String inputCaptcha;
        ...
        System.out.println("SELAMAT DATANG DI TDRK MART");
            System.out.println("========================");
            ...
            if (eCaptcha == false) {
                ...
                if (eUserName == false && ePassword == false) {
                    ...
                    try {
                        ...
                        System.out.println("");
                        System.out.println("\t\033[1m\033[31mDrk Mart\033[0m");
